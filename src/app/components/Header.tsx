...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-white-900 font-montserrat font-bold text-xl text-white">
      {/* Top Bar */}
      <div className="hidden sm:flex justify-between bg-customDarkBlue items-center py-2 px-4 text-sm border-b border-gray-700">
        {/* Contact Info */}
      ...
      {/* Main Navigation */}
      <div className="flex justify-between text-customDarkBlue items-center py-4 px-4">
        {/* Logo */}
